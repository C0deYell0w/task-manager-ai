...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div
                ...
                <div class="d-flex align-center w-100 flex-wrap">
                    ...
                    <h1 class="text-h5 font-weight-black text-white mr-6 mb-0">Create New Task</h1>
        ...
        <v-card color="bg-surface" elevation="0" class="border-0 pa-6">
            <v-form @submit.prevent="submit" class="no-border-form">
...
<style>
.no-border-form .v-field__outline {
    display: none !important;
}
.no-border-form .v-field {
    box-shadow: none !important;
    border: none !important;
}
.no-border-form .v-field__input,
